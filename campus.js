...
function updateLanguageUI() {
    ...
    if (viseurText) {
        // Only overwrite if it's currently showing a default message, not a city name
        const currentText = viseurText.innerText.toUpperCase();
        if (currentText === 'TURN THE KNOB...' || currentText === 'ノブを回して...') {
            viseurText.innerText = t.viseurDefault;
        }
    }
    // Dummy condition to replace the old block cleanly:
    if (false) {
